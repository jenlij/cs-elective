    ...
    def fix_violations(self, violating_node):
        ...
        if uncle is None or uncle.color == RBNode.BLACK:
            if violating_node.is_right_node() and parent.is_right_node():
                ...
                parent.toggle_color()
            elif violating_node.is_left_node() and parent.is_right_node():
            ...
            if grandparent == self.root or (grandparent.parent is not None and grandparent.parent.color == RBNode.RED):
